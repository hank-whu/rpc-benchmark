...
public class Config {
	 ...
	 */
	public static final String PUBLISH_CHANNEL = "aeron:udp?endpoint=benchmark-server:40124";

	/**
	 * The channel (an endpoint identifier) to recive the message
	 */
	public static final String SUBSCRIBE_CHANNEL = "aeron:udp?endpoint=benchmark-client:40123";
