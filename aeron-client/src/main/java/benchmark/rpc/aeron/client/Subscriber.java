...
public class Subscriber implements FragmentHandler, Closeable {
	...
	private final ResponseCallback requestCallback;
	...
	public Subscriber(ResponseCallback responseCallback) {
	...
	public void onFragment(DirectBuffer buffer, int offset, int length, Header header) {
		try (InputStream inputStream = new DirectBufferInputStream(buffer, offset, length);
			...
			Response response = kryoHolder.get().readObject(input, Response.class);
